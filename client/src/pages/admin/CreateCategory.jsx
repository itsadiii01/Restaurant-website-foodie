  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        `https://aditya-mern-backend.onrender.com/api/v1/category/create-category`,
        { name }
      );
      if (data?.success) {
  ...
  const getAllCategory= async () => {
    try {
      const { data } = await axios.get(
        `https://aditya-mern-backend.onrender.com/api/v1/category/get-category`
      );
      if (data.success) {
...
const handleUpdate = async (e) => {
    ...
    try {
      const { data } = await axios.put(
        `https://aditya-mern-backend.onrender.com/api/v1/category/update-category/${selected._id}`,
        { name: updatedName }
      );
      if (data.success) {
...
const handleDelete = async (pId) => {
    try {
      const { data } = await axios.delete(
        `https://aditya-mern-backend.onrender.com/api/v1/category/delete-category/${pId}`
      );
      if (data.success) {
