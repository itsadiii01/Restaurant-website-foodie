...
const UpdateProduct = () => {
  ...
  const getAllCategory = async () => {
    try {
      const { data } = await axios.get(`https://restaurant-website.up.railway.app/api/v1/category/get-category`);
      if (data?.success) {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const { data } = axios.put(
        `https://restaurant-website.up.railway.app/api/v1/product/update-product/${id}`,
        productData
      );
      if (data?.success) {
  ...
  const handleDelete = async () => {
    try {
      ...
      const { data } = await axios.delete(
        `https://restaurant-website.up.railway.app/api/v1/product/delete-product/${id}`
      );
          ...
          <div className="max-w-lg mx-auto">
            ...
            <div className="mb-3">
              {photo ? (
                ...
                <div className="text-center">
                  <img
                    src={`https://restaurant-website.up.railway.app/api/v1/product/product-photo/${id}`}
                    alt="product_photo"
                    height={"200px"}
                    className="img img-responsive"
                  />
